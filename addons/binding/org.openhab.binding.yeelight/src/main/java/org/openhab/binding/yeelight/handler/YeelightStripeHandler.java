...
public class YeelightStripeHandler extends YeelightHandlerBase {
    ...
    public void handleCommand(ChannelUID channelUID, Command command) {
        ...
        mLogger.info(TAG + ": command type: " + command.getClass().toString());
        mLogger.info(TAG + ": device id: " + channelUID.getThingUID().getId());
        mLogger.info(TAG + ": channelUID : " + channelUID.getId());
