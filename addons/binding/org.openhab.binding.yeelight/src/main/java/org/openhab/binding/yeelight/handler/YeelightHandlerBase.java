...
public abstract class YeelightHandlerBase extends BaseThingHandler
    ...
    public void initialize() {
        ...
        // device.registerDeviceStatusListener();
    ...
    public void onConnectionStateChanged(ConnectState connectState) {
        mLogger.debug("###########-->onConnectionStateChanged -> " + connectState.name());
        switch (connectState) {
            case DISCONNECTED:
    ...
    public void channelLinked(ChannelUID channelUID) {
        mLogger.debug("---> channelLinked updateState->" + channelUID.getId());
    ...
    public void onStatusChanged(String prop, DeviceStatus status) {
        mLogger.debug("--->updateState->" + status);
        updateUI(status);
    }
}
